...
$query = "SELECT att.subject, att.attendance, total.total_lectures  from class".$class."_attendance att INNER JOIN tagging total ON att.subject = total.subject WHERE att.st_email = '$email' AND total.class_allot= '$class'";
$result = mysqli_query($con,$query);
...
<b style="text-align: center; color: red; font-size:22px;">Required attendance Percentage for getting pass grade > 75%</b>
</marquee>
...
<!-- database coloumn name -->
			...
			<td>  <?php 
			   ...
			   $percentage = round($row['attendance']/$row['total_lectures'], 4)*100;
